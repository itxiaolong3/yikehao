<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"E:\mydemo\yikehao/application/admin\view\permission\index.html";i:1544786375;s:59:"E:\mydemo\yikehao\application\admin\view\common\header.html";i:1546569129;s:59:"E:\mydemo\yikehao\application\admin\view\common\footer.html";i:1542697499;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="<?php echo url('admin/Index/index'); ?>">首页</a> <span class="c-gray en">&gt;</span> 管理员管理 <span class="c-gray en">&gt;</span> 权限管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c">
				<!--<form class="Huiform" method="post" action="" target="_self">-->
					<input type="text" class="input-text" style="width:250px" placeholder="权限名称" id="keyword" value="<?php echo $keyword; ?>" name="keyword">
					<button type="submit" class="btn btn-success" id="findkeyword"><i class="Hui-iconfont">&#xe665;</i> 搜权限节点</button>
				<!--</form>-->
			</div>
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
				<a href="javascript:;" onclick="admin_permission_add('添加权限节点','<?php echo url('admin/permission/addpermission'); ?>','','310')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加权限节点</a></span>
			...
			<table class="table table-border table-bordered table-bg">
				...
				<tr class="text-c">
					...
					<td><a title="编辑" href="javascript:;" onclick="admin_permission_edit('角色编辑','<?php echo url('admin/permission/addpermission',['id'=>$vo['id']]); ?>','1','','310')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
//    搜索
    $("#findkeyword").click(function () {
        ...
        //$.post("",{keyword:getkeyword},function (a) {
            window.location.href="<?php echo url('admin/permission/index'); ?>?keyword="+getkeyword;
       // })
