<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"E:\mydemo\yikehao/application/admin\view\typelist\index.html";i:1546569129;s:59:"E:\mydemo\yikehao\application\admin\view\common\header.html";i:1546569129;s:59:"E:\mydemo\yikehao\application\admin\view\common\footer.html";i:1542697499;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<article class="cl pd-20">
			<div class="text-c">
				<!--<form class="Huiform" method="post" action="" target="_self">-->
					<input type="text" class="input-text" style="width:250px" placeholder="分类名称" id="keyword" value="<?php echo $keyword; ?>" name="keyword">
					<button type="submit" class="btn btn-success" id="findkeyword"><i class="Hui-iconfont">&#xe665;</i> 查找</button>
				<!--</form>-->
			</div>
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
				<a href="javascript:;" onclick="admin_type_add('添加分类','<?php echo url('admin/typelist/addtype'); ?>','','310')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加分类</a></span>
			...
			<table class="table table-border table-bordered table-bg">
				...
				<tr class="text-c">
					...
					<td><a title="编辑" href="javascript:;" onclick="admin_type_edit('编辑','<?php echo url('admin/typelist/addtype',['tid'=>$vo['tid']]); ?>','1','','310')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a title="删除" href="javascript:;" onclick="admin_type_del(this,'<?php echo $vo['tid']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
...
<script type="text/javascript">
    ...
    $("#types").addClass("current");
//    搜索
    $("#findkeyword").click(function () {
        layer.load();
        var getkeyword=$('#keyword').val();
        //$.post("",{keyword:getkeyword},function (a) {
            window.location.href="<?php echo url('admin/typelist/index'); ?>?keyword="+getkeyword;
       // })
