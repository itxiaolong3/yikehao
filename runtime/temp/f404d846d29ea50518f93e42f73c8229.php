<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"E:\mydemo\yikehao/application/index\view\servesnews\index.html";i:1545810983;}*/ ?>
﻿<!DOCTYPE html>
...
<head>
    ...
    <link rel="shortcut icon" href="/file/logo/20171030/1509328273_67100000.jpg"/>
    <title>行业新闻</title>
    <meta name="keywords" content="行业新闻" />
    <meta name="description" content="行业新闻" />    <script type="text/javascript">
    var sna = '',
        kfqq = '',
        fwrx = '',
        yqtp = '/front/wap/images/j3trrllw.jpg',
        yqlj = 'http://yun.mmd6666.com/login/',
        hli = [
            [
                [62, "美食"],
                [57, "文摘"],
    ...
    //        focus=eval('(' + focus + ')');
    var focus = [
//            ["j3bp5omk.jpg", "j4hux3oc.jpg", 0, "WeChat.aspx"],
//            ["j3koii54.jpg", "j41mm4am.jpg", 0, "Fans.aspx"],
//            ["j5je0oo3.jpg", "j5je0ih0.jpg", 0, "WeChat.aspx?c=^B^B^B^B^B^B^B100000^B^B^B^B^B^B^B^B"],
//            ["j67jcodh.jpg", "j67jes8t.jpg", 0, "http://service.wxtt.cn/"],
//            ["j5je7irg.jpg", "j5je7nmd.jpg", 0, "ServiceDetail.aspx?id=4"],
//            ["j5je9glc.jpg", "j5je9jbg.jpg", 0, "FansDetail.aspx?id=1"]
    ];
    var qq="";
    var lablePic='j3lbx8pt.png';
</script>
    <script>
        var _hmt = _hmt || [];
        (function() {
            var hm = document.createElement("script");
            hm.src = "https://hm.baidu.com/hm.js?030c02b2f23fb95646bd0071e353f075";
...
<div style="display: none" id="header">
    <div>
        <div>您好，欢迎来到号可易！
            <p><s><a class="link">联系客服</a></s><s><a>服务热线：</a><i></i></s></p>
        </div>
    </div>
    <!--    <form>-->
        <div>
            <div><img onclick="gethref(this)" hc-href="/"  alt="公众号出售-公众号价格-公众号买卖-万易云公众号交易平台" src="/yikehao/public/static/index/picture/1522210272_68400000.jpg">
                <div><em><input class="hc-input" hc-title name="title" placeholder="输入您需求的关键词，如“订阅号”"><input type="submit" value="" class="hc-sub" /></em>
                    <ul>
...
<div id="header2">
    ...
    <div>
        <div style="margin: 0 auto;width: 1200px;position: relative">您好，欢迎来到号可易！
            <p>
                <span><a class="link" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2852853898&site=qq&menu=yes">联系客服</a></span><span><a>服务热线：</a><i>173-5987-2786</i></span>
                <span class="hc-show" style="position: relative">
                    <a>关注号可易</a><span class="mj-xia"></span>


                    <div class="hmenu_bd header_menu" style="display: none">
                        <div class="wechat">
                            <div class="wech_fl">
                                <img src="/yikehao/public/static/index/picture/1515422153_51200000.jpg" width="144" alt="号可易微信公众号">
            <p>关注号可易微信公众号</p>
        </div>
        <div class="cut_line"></div>
        <div class="wech_fr">
            <img src="/yikehao/public/static/index/picture/1515421962_5887500.jpg" width="144" alt="号可易客服微信">
            <p>添加号可易客服微信</p>
        </div>
    </div>
</div>
...
<script>
    $(".hc-show").mouseover(function(){
        $('.hmenu_bd').show();
    })
    $(".hc-show").mouseout(function(){
        $('.hmenu_bd').hide();
    })
</script>
<form action="" method="get" >
    <div>
        <div><img onclick="gethref(this)" hc-href="/"  alt="公众号出售-公众号价格-公众号买卖-万易云公众号交易平台" src="/yikehao/public/static/index/picture/1522210272_68400000.jpg">
            ...
            <!--            <s><img src="/yikehao/public/static/index/picture/j3trrllw.jpg"></s>-->
        </div>
    </div>
</form>
</div>
<script>
    $("[hc-sub]").click(function(){
        ...
        var _href="product_8_2.html?title="+_title;
...
<div id="header_nav2" >
    <div class="mj-hv-total"  style="position: relative;height: 70px">
        <ul>
            <li><a mj-hv-sh-none  href="index.html" class="link">首页</a></li>
            <li><a   mj-hv-sh  href="product_8_2.html" class="link">公众号转让</a></li>
            <li style="margin:0"></li>
            <li style="margin:0"></li>
            <li><a   mj-hv-sh-none  href="about_14_38.html" class="link">公众号迁移</a></li>
            <li style="position: relative">
                <span  style="left: 32px;" class="mh-new"></span>
                <a  mj-hv-sh-none  href="about_19_1289.html" class="link">涨粉</a>
            </li>
            <li style="position: relative">
                <span class="mh-hot"></span>
                <a mj-hv-sh-none  href="messagemai.html?id=12">卖公众号</a>
            </li>
            <li><a   mj-hv-sh-none  href="product_8_2.html">买公众号</a></li>
            <li style="position: relative">
                <a mj-hv-sh-none  href="eval.html" class="link">帐号估值</a>
            </li>
            <li>
                <a  mj-hv-sh-none  href="about_2_1.html" class="link">关于号可易</a>
            </li>

        </ul>
        <div mj-cd id="select_box" class="mj-cd" style="display:none;position: absolute;left: 0;top:69px;z-index:10;width: auto;border: 4px solid #ffda44;border-top: 0" >
            <!--    <div></div>-->
...
<div id="location">当前位置：<a>云乐互联</a> &gt; 服务中心</div>
<div id="services">
    <p><s>服务中心</s></p>
    <em>
        <a href="<?php echo url('index/servesnews/index'); ?>" class="u" >行业新闻</a>
        <a href="<?php echo url('index/serves/index'); ?>" >疑难解答</a>
    </em>
    <ul>
        ...
        <li hc-href="<?php echo url('index/newdetail/index',['id'=>$vo['id']]); ?>" id="detail_1"><s class="" style=""><img class="" style="display: block" data-original="<?php echo $vo['titleimg']; ?>" src="<?php echo $vo['titleimg']; ?>"></s>
            <div>
                <p><?php echo $vo['title']; ?></p>
                <div>
                    <?php echo $vo['desc']; ?>
                </div>
                <i><?php echo $vo['addtime']; ?></i>
            </div>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="clear footer_wrap">
    <div class="box footer" style="width: 1200px;margin: 0 auto">
        <div class="footer_contact">
            <p class="tel">服务热线: 173-5987-2786</p>
        </div>
        <div class="clear footer_service">
            <ul>
                <li>
                    ...
                    <div class="links">
                        <a href="news_5_1_210.html">交易流程</a>
                ...
                <li>
                    ...
                    <div class="links">
                        <a href="bank.html" target="_blank">付款方式</a>
                        <a href="eval.html">估值服务</a>
                        <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=">客服服务</a>
                    </div>
                </li>
                <li>
        ...
        <div class="footer_ewm">
            <img src="/yikehao/public/static/index/picture/1515422153_51200000.jpg" style="width:110px;height:110px;margin-right: 10px">
            <img src="/yikehao/public/static/index/picture/1515421962_5887500.jpg" style="width:110px;height:110px;margin-left: 10px">
        </div>
        <div style="height: 50px;" class="footer_ewm">
            <span style="margin-right: 10px">官方微信</span>
            <span style="margin-left: 10px">客服微信</span>
        </div>
        <div class="clear footer_copyright">
            CopyRight © 2016厦门特斯西网络科技有限公司 All Rights Reserved 本站关键词：云乐互联，微信公众号交易平台，公众号买卖，公众号出售，公众号转让，粉丝迁移，购买公众号 <a href="http://www.miitbeian.gov.cn/" target="_blank"></a>
            <p>客服邮箱：3089442373@qq.com 或致电：173-5987-2786&nbsp;&nbsp;&nbsp;&nbsp;常年法律顾问：林炜锦律师</p>
...
<!--微信分享链接-->
<script src="/yikehao/public/static/index/js/jweixin-1.0.0.js"></script>
<script>
    /*
     * 注意：
    ...
    wx.config({
        debug: false,
        appId: 'wxe4ce83bf831bebcf',
        timestamp: 1543658770,
        nonceStr: 'UzAyGZE8PCYnpMOU',
        signature: 'a736669e3ebf31565756e0698e46c5f3cc3ae6d5',
        jsApiList: [
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareAppMessage({
            title: '云乐互联-公众号交易平台|公众号买卖|公众号出售|公众号转让|购买公众号|粉丝迁移', // 分享标题
            desc: '号可易公众号交易平台-出售公众号、购买公众号一对一定制服务，主营：微信公众号交易平台，公众号买卖，公众号出售，公众号转让，粉丝迁移，购买公众号。资深律师为您的交易保驾护航，让您的公众号交易便捷、贴心、更放心！', // 分享描述
            link: 'http://www.shuiren.net/news_15_4.htm', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
            imgUrl: 'http://www.shuiren.net/file/logo/20171023/1508741745_56237500.jpg', // 分享图标
            success: function () {
                // 用户确认分享后执行的回调函数
            },
            cancel: function () {
        ...
        wx.onMenuShareTimeline({
            title: '号可易公众号交易平台-出售公众号、购买公众号一对一定制服务，主营：微信公众号交易平台，公众号买卖，公众号出售，公众号转让，粉丝迁移，购买公众号。资深律师为您的交易保驾护航，让您的公众号交易便捷、贴心、更放心！', // 分享标题
            link: 'http://www.shuiren.net/news_15_4.htm', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
            imgUrl: 'http://www.shuiren.net/file/logo/20171023/1508741745_56237500.jpg', // 分享图标
            success: function () {
                // 用户确认分享后执行的回调函数
