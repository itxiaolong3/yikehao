<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:57:"E:\mydemo\yikehao/application/admin\view\xieyi\index.html";i:1545967433;s:59:"E:\mydemo\yikehao\application\admin\view\common\header.html";i:1545967433;s:59:"E:\mydemo\yikehao\application\admin\view\common\footer.html";i:1542697499;}*/ ?>
﻿<!--引入头部文件，如css-->
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="<?php echo url('admin/Index/index'); ?>">首页</a> <span class="c-gray en">&gt;</span> 协议列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
		...
		<article class="cl pd-20">
			<div class="mt-10">
				<div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l">
				<a href="javascript:;" onclick="admin_xieyi_add('添加协议','<?php echo url('admin/xieyi/addxieyi'); ?>')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加协议</a></span>
				</div>
			<table class="table table-border table-bordered table-hover table-bg">
				...
				<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					<tr class="text-c">
						...
						<td><a title="编辑" href="javascript:;" onclick="admin_xieyi_edit('协议编辑','<?php echo url('admin/xieyi/addxieyi',['id'=>$vo['id']]); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
							<a title="删除" href="javascript:;" onclick="admin_xieyi_del(this,'<?php echo $vo['id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
					</tr>
