<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"E:\mydemo\yikehao/application/index\view\prodetail\index.html";i:1545965729;s:59:"E:\mydemo\yikehao\application\index\view\common\header.html";i:1545810983;}*/ ?>
﻿<!DOCTYPE html>
...
<div id="location">当前位置：云乐互联  &gt; <?php echo $prob['title']; ?></div>

    <div id="detail">
        <div>
            <p><?php echo $prob['title']; ?></p>
            <s><i><?php echo $prob['addtime']; ?></i></s>
        </div>
        <em style="display: initial;">
            <div style="padding: 15px;">
                <?php echo $prob['contents']; ?>
            </div>
        </em>
        <u></u>
    </div>
