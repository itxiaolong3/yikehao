<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"E:\mydemo\yikehao/application/admin\view\permission\addpermis.html";i:1544769521;s:59:"E:\mydemo\yikehao\application\admin\view\common\footer.html";i:1542697499;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="cl pd-20">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $roots['name']; ?>" placeholder="" id="name" name="name">
			</div>
		</div>
		<!--<div class="row cl" style="margin-top: 10px;margin-bottom: 10px;">-->
			<!--<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>权限序号：</label>-->
			<!--<div class="formControls col-xs-8 col-sm-9">-->
				<!--<input type="number" class="input-text" autocomplete="off" value="<?php echo $roots['num']; ?>" placeholder="权限序号" id="num" name="num">-->
			<!--</div>-->
		<!--</div>-->

		<div class="row cl" style="margin-top: 15px;margin-bottom: 15px;">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input type="hidden" value="<?php echo $roots['id']; ?>" name="id" id="getid">
